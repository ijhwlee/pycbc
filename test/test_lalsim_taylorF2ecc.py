...
parser.add_option('--eccentricity', type = float, default=0, help = "[default: %default]")
...
parser.add_option('--f-ecc', type = float, default=-1.0, help = "[default: %default]")
...
parser.add_option('--ecc-order', type = int, default=-1, help = "[default: %default]")
